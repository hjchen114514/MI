...
> **UPDATE [2026-04-06] — Renamed doped_12x9 → doped_36x3:**
> The stratified doped condition is renamed from **doped_12x9** to **doped_36x3** (36 seeds × 3 rewrites) to more accurately reflect the actual data construction used. The 36×3 design was verified to preserve the same human-like/AI-like distribution as the full human dataset, with minor variation in per-number counts. All file paths, model directories, code, and documentation updated accordingly. The scientific intent is unchanged.
...
> 4. **doped_36x3_ft** — fine-tuned on 36×3 stratified doped responses (strong doping). *(renamed from doped_12x9_ft, 2026-04-06)*
>
